  ...
  return (
    <section className="relative">
      ...
      <div
        ...
        aria-hidden="true"
      />
      <div className="absolute bottom-0 left-0 right-0 w-px h-20 p-px m-auto transform translate-y-1/2 bg-gray-200" />

      <div className="relative max-w-6xl px-4 mx-auto sm:px-6">
        <div className="py-12 md:py-20">
          {/* Section header */}
          <div className="max-w-3xl pb-12 mx-auto text-center md:pb-20">
            <h2 className="mb-4 h2">How DataEcho works</h2>
            <p className="text-xl text-gray-600">
              We offer a lens into three core qualities that will improve
              learning:
            </p>
          </div>
